...
export function AvatarEditor({ manifest = avatarManifest, value = defaultAvatar, onChange }: { manifest?: AvatarManifest; value?: AvatarSelection; onChange?: (value: AvatarSelection) => void }) {
